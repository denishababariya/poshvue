      ...
      {mode === 'edit' ? (
        ...
        <div className="d_story_wrapper">
          <style>{`
            ...
            .d_story_section { padding: clamp(50px, 10vw, 100px) 0; }
            .d_story_section h2 { font-size: clamp(28px, 4vw, 42px); font-weight: 700; color: #4a0404; margin-bottom: 25px; }
            ...
            .d_story_values { background: #fdf8f3; padding: 80px 0; }
            ...
            .d_story_why { padding: 80px 0; background: #fff; }
            .d_why_box { padding: 20px; border: 1px dashed #b08d57; height: 100%; }
            .d_why_icon { font-size: 30px; color: #b08d57; margin-bottom: 15px; }
            .d_story_cta { background: linear-gradient(rgba(74, 4, 4, 0.9), rgba(74, 4, 4, 0.9)), url("https://images.unsplash.com/photo-1594142404832-731338604d53?q=80&w=1974&auto=format&fit=crop"); background-size: cover; background-attachment: fixed; color: #fff; text-align: center; padding: 100px 20px; }
            ...
            .d_story_btn:hover { background: #fff; color: #4a0404; }
            @media (max-width: 768px) { .d_story_img { height: 350px; box-shadow: 10px 10px 0px #f4e6d6; } .d_craft_img { height: 300px; border-radius: 10px; } }
          `}</style>
