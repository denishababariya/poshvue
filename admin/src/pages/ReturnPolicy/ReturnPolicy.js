  ...
  return (
    <div className="x_page">
      ...
      <div className="x_page_header">
        <h1>Return Policy Management</h1>
      ...
      {mode === 'edit' ? (
        ...
        /* Preview Mode */
        <div className="d_return_wrapper py-5 bg-light">
          <style>{`
            ...
            .d_return_header { background: linear-gradient(135deg, #4a0404, #8b0000); color: #fff; padding: 40px; text-align: center; }
            ...
            .d_section_title { color: #4a0404; font-size: 1.2rem; font-weight: 600; margin-bottom: 10px; border-bottom: 2px solid #d4af37; padding-bottom: 5px; }
            .d_section_content { color: #555; line-height: 1.7; font-size: 15px; }
            .d_section_content strong { color: #4a0404; }
